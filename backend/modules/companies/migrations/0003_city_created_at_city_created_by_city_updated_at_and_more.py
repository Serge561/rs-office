# Generated by Django 5.0 on 2024-01-30 21:39
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='city',
            name='created_by',
            field=models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.SET_DEFAULT, related_name='creator_cities', to=settings.AUTH_USER_MODEL, verbose_name='Создал'),
        ),
        migrations.AddField(
            model_name='city',
            name='updated_at',
        ...
        migrations.AddField(
            model_name='city',
            name='updated_by',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='updater_cities', to=settings.AUTH_USER_MODEL, verbose_name='Обновил'),
        ),
        ...
        migrations.AlterField(
            model_name='company',
            name='creator',
            field=models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.SET_DEFAULT, related_name='creator_company_cards', to=settings.AUTH_USER_MODEL, verbose_name='Создал'),
        ),
        migrations.AlterField(
            model_name='company',
            name='time_create',
        ...
        migrations.AlterField(
            model_name='company',
            name='updater',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='updater_company_cards', to=settings.AUTH_USER_MODEL, verbose_name='Обновил'),
        ),
    ]
