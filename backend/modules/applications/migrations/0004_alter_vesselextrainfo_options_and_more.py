# Generated by Django 5.0 on 2024-03-02 21:31
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('applications', '0003_alter_vessel_me_power'),
    ...
    operations = [
        migrations.AlterModelOptions(
            ...
            options={'verbose_name': 'Дополнительные данные по судну и заявке', 'verbose_name_plural': 'Дополнительные данные по судам и заявкам'},
        ),
        migrations.RemoveField(
            model_name='application',
            name='assigned_surveyors',
        ),
        migrations.RemoveField(
            model_name='application',
        ...
        migrations.AddField(
            ...
            name='assigned_surveyors',
            field=models.ManyToManyField(to=settings.AUTH_USER_MODEL, verbose_name='Исполнители заявки'),
        ),
        migrations.AddField(
            model_name='vesselextrainfo',
            name='completion_expected_date',
            field=models.DateField(blank=True, null=True, verbose_name='Ожидаемая дата завершения ремонта'),
        ),
